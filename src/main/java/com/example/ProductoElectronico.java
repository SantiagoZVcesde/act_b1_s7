...
public class ProductoElectronico extends Producto {
    ...
    public ProductoElectronico(String nombre, double precioBase, String codigo, int cantidadStock,
                               String categoria, int garantiaMeses, String marca,
                               double voltaje, boolean esImportado) {
    ...
    public double calcularPrecioElectronico() {
        ...
        if (esImportado) precio += precioBase * 0.05; // impuesto importado
    ...
    public boolean esCompatibleVoltaje(double voltajeLocal) {
        ...
        return diferencia <= (0.1 * voltajeLocal);
    }
}